...
;(setq ac-dictionary-directories "/home/tpallatto/lib/emacs/imported/auto-complete/dict")
;(require 'auto-complete-config)
;(ac-config-default)

(add-to-list 'load-path "/home/tpallatto/lib/emacs/local/")
(require 'org_prefs)
(require 'perl_prefs)
;(require 'tramp_prefs)
...
(add-to-list 'load-path "/home/tpallatto/.emacs.d/pde/")
;(add-to-list 'load-path "/home/tpallatto/lib/emacs/imported/emacs-jabber-0.8.0/")
